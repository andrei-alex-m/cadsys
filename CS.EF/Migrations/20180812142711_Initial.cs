        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdImobilReferinta = table.Column<int>(nullable: false),
                    IdForerinta = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InscrieriDetaliu", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InscrieriDetaliu_Imobil_IdForerinta",
                        column: x => x.IdForerinta,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InscrieriDetaliu_IdForerinta",
